...
{
    private static final IBlockState DEFAULT_TRUNK = Blocks.apple_log.getDefaultState();
    private static final IBlockState DEFAULT_LEAF = Blocks.apple_leaves.getDefaultState().withProperty(BlockVarietyLeaves.DECAYABLE, Boolean.valueOf(true));
