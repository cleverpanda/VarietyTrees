...
{
	static final IBlockState TRUNK = Blocks.willow_log.getDefaultState();
    private static final IBlockState LEAF = Blocks.willow_leaves.getDefaultState().withProperty(BlockVarietyLeaves.DECAYABLE, Boolean.valueOf(true));
