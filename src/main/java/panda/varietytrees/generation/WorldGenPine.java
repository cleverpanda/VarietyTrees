...
{
	private static final IBlockState TRUNK = Blocks.pine_log.getDefaultState();
    private static final IBlockState LEAF = Blocks.pine_leaves.getDefaultState().withProperty(BlockVarietyLeaves.DECAYABLE, Boolean.valueOf(true));
