...
{
	static final IBlockState TRUNK = Blocks.yew_log.getDefaultState();
    private static final IBlockState LEAF = Blocks.yew_leaves.getDefaultState().withProperty(BlockVarietyLeaves.DECAYABLE, Boolean.valueOf(true));
