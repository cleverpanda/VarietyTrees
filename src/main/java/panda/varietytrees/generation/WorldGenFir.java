...
{
	private static final IBlockState TRUNK = Blocks.fir_log.getDefaultState();
    private static final IBlockState LEAF = Blocks.fir_leaves.getDefaultState().withProperty(BlockVarietyLeaves.DECAYABLE, Boolean.valueOf(true));
