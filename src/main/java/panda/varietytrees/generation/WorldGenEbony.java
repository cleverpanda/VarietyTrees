...
{
	private static final IBlockState TRUNK = Blocks.ebony_log.getDefaultState();
    private static final IBlockState LEAF = Blocks.ebony_leaves.getDefaultState().withProperty(BlockVarietyLeaves.DECAYABLE, Boolean.valueOf(true));
