package panda.varietytrees.generation;
...
{
    private static final IBlockState DEFAULT_TRUNK = Blocks.maple_log.getDefaultState();
    private static final IBlockState DEFAULT_LEAF = Blocks.maple_leaves.getDefaultState().withProperty(BlockVarietyLeaves.DECAYABLE, Boolean.valueOf(true));
    ...
    public WorldGenMaple(boolean p_i2027_1_)
    {
        this(p_i2027_1_, 4, DEFAULT_TRUNK, DEFAULT_LEAF);
    }

    public WorldGenMaple(boolean p_i46446_1_, int height, IBlockState metawood, IBlockState metaleaves)
    {
        super(p_i46446_1_);
