...
import panda.varietytrees.generation.WorldGenApple;
import panda.varietytrees.generation.WorldGenEbony;
import panda.varietytrees.generation.WorldGenFir;
import panda.varietytrees.generation.WorldGenMaple;
import panda.varietytrees.generation.WorldGenPine;
import panda.varietytrees.generation.WorldGenWillow;
import panda.varietytrees.generation.WorldGenYew;
...
public class BlockVarietySapling extends BlockBush implements IOreDictionaryEntry, IGrowable, IPlantable 
{
	    ...
	    public BlockVarietySapling(WoodMaterial wood)
	    {
	    	this.wood = wood;
