...
public class SpecialFire extends BlockFire {
    ...
    {
        if (!worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP) && !((BlockFire) panda.varietytrees.init.Blocks.specialfire).canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
    ...
    {
    	((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.PLANKS, 5, 20);
    	((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.DOUBLE_WOODEN_SLAB, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.WOODEN_SLAB, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.OAK_FENCE_GATE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.SPRUCE_FENCE_GATE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.BIRCH_FENCE_GATE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.JUNGLE_FENCE_GATE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.DARK_OAK_FENCE_GATE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.ACACIA_FENCE_GATE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.OAK_FENCE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.SPRUCE_FENCE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.BIRCH_FENCE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.JUNGLE_FENCE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.DARK_OAK_FENCE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.ACACIA_FENCE, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.OAK_STAIRS, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.BIRCH_STAIRS, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.SPRUCE_STAIRS, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.JUNGLE_STAIRS, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.ACACIA_STAIRS, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.DARK_OAK_STAIRS, 5, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.LOG, 5, 5);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.LOG2, 5, 5);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.LEAVES, 30, 60);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.LEAVES2, 30, 60);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.BOOKSHELF, 30, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.TNT, 15, 100);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.TALLGRASS, 60, 100);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.DOUBLE_PLANT, 60, 100);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.YELLOW_FLOWER, 60, 100);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.RED_FLOWER, 60, 100);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.DEADBUSH, 60, 100);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.WOOL, 30, 60);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.VINE, 15, 100);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.COAL_BLOCK, 5, 5);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.HAY_BLOCK, 60, 20);
        ((BlockFire) panda.varietytrees.init.Blocks.specialfire).setFireInfo(Blocks.CARPET, 60, 20);
        ...
        if (random.nextInt(chance) < i)
        {
            ...
            else
            {
                ...
                if(iblockstate.getBlock() instanceof BlockLog){
                	ItemStack burnitem = worldIn.rand.nextBoolean()? new ItemStack(panda.varietytrees.init.Items.ash): new ItemStack(net.minecraft.init.Items.COAL,1,1);
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        ...
        if (!worldIn.getBlockState(pos.down()).isSideSolid(worldIn, pos.down(), EnumFacing.UP) && !((BlockFire) panda.varietytrees.init.Blocks.specialfire).canCatchFire(worldIn, pos.down(), EnumFacing.UP))
        {
            if (((BlockFire) panda.varietytrees.init.Blocks.specialfire).canCatchFire(worldIn, pos.west(), EnumFacing.EAST))
            {
                for (int j = 0; j < 2; ++j)
                {
            ...
            if (((BlockFire) panda.varietytrees.init.Blocks.specialfire).canCatchFire(worldIn, pos.east(), EnumFacing.WEST))
            {
                for (int k = 0; k < 2; ++k)
                {
            ...
            if (((BlockFire) panda.varietytrees.init.Blocks.specialfire).canCatchFire(worldIn, pos.north(), EnumFacing.SOUTH))
            {
                for (int l = 0; l < 2; ++l)
                {
            ...
            if (((BlockFire) panda.varietytrees.init.Blocks.specialfire).canCatchFire(worldIn, pos.south(), EnumFacing.NORTH))
            {
            ...
            if (((BlockFire) panda.varietytrees.init.Blocks.specialfire).canCatchFire(worldIn, pos.up(), EnumFacing.DOWN))
            {
